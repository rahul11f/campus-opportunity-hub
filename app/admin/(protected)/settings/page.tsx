      ...
      <div className="grid gap-6">
        ...
        <div className="admin-card rounded-xl p-6 border border-white/10">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-1.5">Platform Name</label>
              <input
                type="text"
                value={settings.siteName}
                onChange={e => setSettings({ ...settings, siteName: e.target.value })}
                className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white text-sm focus:outline-none focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
        ...
        <div className="admin-card rounded-xl p-6 border border-white/10">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/10 transition-colors">
              <div>
                <p className="text-sm font-medium text-white">Enable Student Contributions</p>
                <p className="text-xs text-gray-400 mt-0.5">Allow students to submit new opportunities from dashboard.</p>
              </div>
              <div className="relative">
                ...
                <div className={`block w-10 h-6 rounded-full transition-colors ${settings.enableStudentContributions ? 'bg-green-500' : 'bg-gray-600'}`}></div>
            ...
            <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/10 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Submitted opportunities go to drafts first.</p>
              </div>
              <div className="relative">
                ...
                <div className={`block w-10 h-6 rounded-full transition-colors ${settings.requireAdminApproval ? 'bg-green-500' : 'bg-gray-600'}`}></div>
            ...
            <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/10 transition-colors">
              <div>
                <p className="text-sm font-medium text-white">Enable Google AdSense</p>
                <p className="text-xs text-gray-400 mt-0.5">Show ads minimally across the platform.</p>
              </div>
              <div className="relative">
                ...
                <div className={`block w-10 h-6 rounded-full transition-colors ${settings.enableAds ? 'bg-green-500' : 'bg-gray-600'}`}></div>
            ...
            <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/10 transition-colors">
              <div>
                ...
                <p className="text-xs text-red-400/70 mt-0.5">Disable access to the public student portal.</p>
              </div>
              <div className="relative">
                ...
                <div className={`block w-10 h-6 rounded-full transition-colors ${settings.maintenanceMode ? 'bg-red-500' : 'bg-gray-600'}`}></div>
